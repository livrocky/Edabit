!(function (e) {
  ...
  function (e, t, n) {
    ...
    !(function (t, n) {
      ...
      function p(e) {
        var t = {};
        return (
          ke.each(e.match(Me) || [], function (e, n) {
            t[n] = !0;
          }),
          t
        );
      ...
      function v() {
        ce.removeEventListener('DOMContentLoaded', v), n.removeEventListener('load', v), ke.ready();
      }
      function m(e, t) {
        return t.toUpperCase();
      }
      function y(e) {
        return e.replace($e, 'ms-').replace(Be, m);
      }
      function x() {
      ...
      function b(e) {
        return (
          'true' === e ||
          ('false' !== e &&
            ('null' === e ? null : e === +e + '' ? +e : Xe.test(e) ? JSON.parse(e) : e))
        );
      }
      function w(e, t, n) {
        var r;
      ...
      function T(e, t, n, r) {
        var i,
          ...
          c = (ke.cssNumber[t] || ('px' !== l && +u)) && Ge.exec(ke.css(e, t));
        if (c && c[3] !== l) {
          for (u /= 2, l = l || c[3], c = +u || 1; a--; )
            ke.style(e, t, c + l), (1 - o) * (1 - (o = s() / u || 0.5)) <= 0 && (a = 0), (c /= o);
        ...
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
          (r = e[o]),
            r.style &&
              ...
              t
                ? ('none' === n &&
                    ((i[o] = _e.get(r, 'display') || null), i[o] || (r.style.display = '')),
                  '' === r.style.display && Qe(r) && (i[o] = C(r)))
                : 'none' !== n && ((i[o] = 'none'), _e.set(r, 'display', n)));
      ...
      function D(e, t, n, r, i) {
        for (
          var o, a, u, l, c, f, p = t.createDocumentFragment(), d = [], h = 0, g = e.length;
          h < g;
          h++
        )
          if ((o = e[h]) || 0 === o)
            if ('object' === s(o)) ke.merge(d, o.nodeType ? [o] : o);
            else if (rt.test(o)) {
              for (
                a = a || p.appendChild(t.createElement('div')),
                  u = (et.exec(o) || ['', ''])[1].toLowerCase(),
                  l = nt[u] || nt._default,
                  a.innerHTML = l[1] + ke.htmlPrefilter(o) + l[2],
                  f = l[0];
                f--;
      ...
      function R(e, t, n, r) {
        ...
        if (
          ...
          for (s = ke.map(k(i, 'script'), H), u = s.length; f < p; f++)
            (l = i),
              f !== d && ((l = ke.clone(l, !0, !0)), u && ke.merge(s, k(l, 'script'))),
              n.call(e[f], l, f);
          if (u)
            for (c = s[s.length - 1].ownerDocument, ke.map(s, O), f = 0; f < u; f++)
              (l = s[f]),
                tt.test(l.type || '') &&
                  !_e.access(l, 'globalEval') &&
                  ke.contains(c, l) &&
                  (l.src && 'module' !== (l.type || '').toLowerCase()
                    ? ke._evalUrl && ke._evalUrl(l.src)
                    : a(l.textContent.replace(ft, ''), c, l));
        }
        return e;
      }
      function I(e, t, n) {
        for (var r, i = t ? ke.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
          n || 1 !== r.nodeType || ke.cleanData(k(r)),
            r.parentNode &&
              (n && ke.contains(r.ownerDocument, r) && S(k(r, 'script')),
      ...
      function W(e, t, n) {
        ...
        return (
          ...
          n &&
            ...
            '' !== a || ke.contains(e.ownerDocument, e) || (a = ke.style(e, t)),
            !we.pixelBoxStyles() &&
              pt.test(a) &&
              ht.test(t) &&
              ((r = s.width),
      ...
      function z(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
          'margin' === n && (u += ke.css(e, n + Ye[a], !0, i)),
            r
              ? ('content' === n && (u -= ke.css(e, 'padding' + Ye[a], !0, i)),
                'margin' !== n && (u -= ke.css(e, 'border' + Ye[a] + 'Width', !0, i)))
              : ((u += ke.css(e, 'padding' + Ye[a], !0, i)),
                'padding' !== n
                  ? (u += ke.css(e, 'border' + Ye[a] + 'Width', !0, i))
                  : (s += ke.css(e, 'border' + Ye[a] + 'Width', !0, i)));
        return (
          !r &&
            o >= 0 &&
            (u += Math.max(
      ...
      function X(e, t, n) {
        ...
        return (
          (a = a && (we.boxSizingReliable() || i === e.style[t])),
          ('auto' === i || (!parseFloat(i) && 'inline' === ke.css(e, 'display', !1, r))) &&
            ((i = e['offset' + t[0].toUpperCase() + t.slice(1)]), (a = !0)),
          (i = parseFloat(i) || 0) + z(e, t, n || (o ? 'border' : 'content'), a, r, i) + 'px'
        );
      }
      ...
      function V() {
        Tt &&
          (!1 === ce.hidden && n.requestAnimationFrame
            ? n.requestAnimationFrame(V)
            : n.setTimeout(V, ke.fx.interval),
          ke.fx.tick());
      }
      function G() {
        return (
      ...
      function Q(e, t, n) {
        for (
          var r, i = (Z.tweeners[t] || []).concat(Z.tweeners['*']), o = 0, a = i.length;
          o < a;
          o++
        )
        ...
        if ((u = !ke.isEmptyObject(t)) || !ke.isEmptyObject(d)) {
          f &&
            ...
            'none' === c &&
              (l
                ? (c = l)
                : (E([e], !0), (l = e.style.display || l), (c = ke.css(e, 'display')), E([e]))),
      ...
      function Z(e, t, n) {
        ...
        for (K(c, l.opts.specialEasing); o < a; o++)
          if ((r = Z.prefilters[o].call(l, e, c, l.opts)))
            return Te(r.stop) && (ke._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        return (
          ke.map(c, Q, l),
      ...
      function re(e, t, n, r) {
        ...
        if (Array.isArray(t))
          ke.each(t, function (t, i) {
            n || Pt.test(e)
              ? r(e, i)
              : re(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r);
          });
          ...
          if (
            ...
            if ('*' === o) o = u;
              ...
              if (!(a = l[u + ' ' + o] || l['* ' + o]))
                for (i in l)
                  if (
                    ((s = i.split(' ')), s[1] === o && (a = l[u + ' ' + s[0]] || l['* ' + s[0]]))
                  ) {
              ...
              if (null != (e = arguments[s]))
                for (t in e)
                  (n = a[t]),
                    (r = e[t]),
                    a !== r &&
                      (l && r && (ke.isPlainObject(r) || (i = Array.isArray(r)))
                        ? (i
        ...
        ke.extend({
          ...
          isPlainObject: function (e) {
            ...
            return (
              ...
              (!(t = fe(e)) ||
                ('function' == typeof (n = ye.call(t, 'constructor') && t.constructor) &&
                  xe.call(n) === be))
            );
          },
          ...
          makeArray: function (e, t) {
            ...
            return (
              null != e &&
                (u(Object(e)) ? ke.merge(n, 'string' == typeof e ? [e] : e) : he.call(n, e)),
              n
            );
          },
        ...
        (function (e) {
          function t(e, t, n, r) {
            ...
            if (((n = n || []), 'string' != typeof e || !e || (1 !== h && 9 !== h && 11 !== h)))
              return n;
            if (!r && ((t ? t.ownerDocument || t : W) !== q && A(t), (t = t || q), H)) {
              if (11 !== h && (u = ge.exec(e)))
                if ((i = u[1])) {
                  if (9 === h) {
                ...
                return r !== q && 9 === r.nodeType && r.documentElement
                  ? ((q = r),
                    ...
                    (b.getElementsByTagName = i(function (e) {
                      return (
                        e.appendChild(q.createComment('')), !e.getElementsByTagName('*').length
                      );
                    })),
                      ...
                      ? function (e, t) {
                          ...
                          return (
                            ...
                            1 & n || (!b.sortDetached && t.compareDocumentPosition(e) === n)
                              ? e === q || (e.ownerDocument === W && R(W, e))
                                ? -1
                                : t === q || (t.ownerDocument === W && R(W, t))
                                ? 1
                                : N
                                ? K(N, e) - K(N, t)
                                : 0
                  ...
                  lang: r(function (e) {
                    return (
                      ...
                      function (t) {
                        ...
                        do {
                          if (
                            (n = H ? t.lang : t.getAttribute('xml:lang') || t.getAttribute('lang'))
                          )
        ...
        if (((n = n || Le), 'string' == typeof e)) {
          ...
          if (r[1]) {
            if (
              ...
              ke.merge(this, ke.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ce, !0)),
        ...
        ke.each(
          {
            ...
            contents: function (e) {
              return l(e, 'iframe')
                ? e.contentDocument
                : (l(e, 'template') && (e = e.content || e), ke.merge([], e.childNodes));
            },
          },
          function (e, t) {
            ke.fn[e] = function (n, r) {
              ...
              return (
                ...
                this.length > 1 && (Pe[e] || ke.uniqueSort(i), Oe.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
        ...
        var t,
          ...
          c = {
            ...
            fireWith: function (e, n) {
              return (
                i || ((n = n || []), (n = [e, n.slice ? n.slice() : n]), a.push(n), t || l()), this
              );
            },
            fire: function () {
        ...
        ke.extend({
            ...
            var t = [
              ...
              i = {
                ...
                then: function (e, r, i) {
                          ...
                          : function () {
                              try {
                                ...
                                ke.Deferred.exceptionHook &&
                                  ke.Deferred.exceptionHook(n, c.stackTrace),
                                  e + 1 >= a &&
                                    (r !== h && ((s = void 0), (u = [n])), t.rejectWith(s, u));
                              }
                            };
                      e
                        ? c()
                        : (ke.Deferred.getStackHook && (c.stackTrace = ke.Deferred.getStackHook()),
                          n.setTimeout(c));
                    };
                  }
                  var a = 0;
                  return ke
                    .Deferred(function (n) {
                      t[0][3].add(o(0, n, Te(i) ? i : d, n.notifyWith)),
                        t[1][3].add(o(0, n, Te(e) ? e : d)),
          ...
          when: function (e) {
            ...
            if (
              ...
              'pending' === o.state() || Te(i[n] && i[n].then))
            )
              return o.then();
      ...
      (ke.fn.ready = function (e) {
        ...
        ke.extend({
          ...
          ready: function (e) {
            (!0 === e ? --ke.readyWait : ke.isReady) ||
              ((ke.isReady = !0), (!0 !== e && --ke.readyWait > 0) || Ie.resolveWith(ce, [ke]));
          },
        }),
        ...
        ('loading' !== ce.readyState && !ce.documentElement.doScroll)
          ...
          : (ce.addEventListener('DOMContentLoaded', v), n.addEventListener('load', v));
        ...
        ke.fn.extend({
          data: function (e, t) {
            ...
            if (void 0 === e) {
              if (
                this.length &&
                ((i = ze.get(o)), 1 === o.nodeType && !_e.get(o, 'hasDataAttrs'))
              ) {
                for (n = a.length; n--; )
                  a[n] &&
                    ((r = a[n].name),
                    0 === r.indexOf('data-') && ((r = y(r.slice(5))), w(o, r, i[r])));
          ...
          queue: function (e, t, n) {
            ...
            if (e)
              return (
                (t = (t || 'fx') + 'queue'),
                (r = _e.get(e, t)),
                n && (!r || Array.isArray(n) ? (r = _e.access(e, t, ke.makeArray(n))) : r.push(n)),
                r || []
              );
          },
        ...
        ke.fn.extend({
          ...
          promise: function (e, t) {
            ...
            for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
              (n = _e.get(o[a], e + 'queueHooks')) && n.empty && (r++, n.empty.add(s));
      ...
      (ke.event = {
          ...
          if (v)
            for (
              n.handler && ((o = n), (n = o.handler), (i = o.selector)),
                i && ke.find.matchesSelector(it, i),
        ...
        remove: function (e, t, n, r, i) {
          ...
          if (v && (u = v.events)) {
            for (t = (t || '').match(Me) || [''], l = t.length; l--; )
              if (
                ((s = st.exec(t[l]) || []), (d = g = s[1]), (h = (s[2] || '').split('.').sort()), d)
              ) {
                for (
                  f = ke.event.special[d] || {},
        ...
        dispatch: function (e) {
          var t,
            ...
            c = ke.event.special[s.type] || {};
          for (u[0] = s, t = 1; t < arguments.length; t++) u[t] = arguments[t];
          if (((s.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, s))) {
            for (
              a = ke.event.handlers.call(this, s, l), t = 0;
              ...
              for (
                ...
                (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
                  ...
                  (s.data = o.data),
                  void 0 !==
                    (r = ((ke.event.special[o.origType] || {}).handle || o.handler).apply(
                      i.elem,
                      u
                    )) &&
                    !1 === (s.result = r) &&
        ...
        ke.each(
          {
            ...
            which: function (e) {
              var t = e.button;
              return null == e.which && ot.test(e.type)
                ? null != e.charCode
                  ? e.charCode
                  : e.keyCode
      ...
      ke.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (!(we.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || ke.isXMLDoc(e)))
            for (a = k(s), o = k(e), r = 0, i = o.length; r < i; r++) M(o[r], a[r]);
          if (t)
            if (n)
              for (o = o || k(e), a = a || k(s), r = 0, i = o.length; r < i; r++) P(o[r], a[r]);
            else P(e, s);
              ...
              function (e) {
                ...
                if (
                  ...
                  try {
                    for (; n < r; n++)
                      (t = this[n] || {}),
                        1 === t.nodeType && (ke.cleanData(k(t, !1)), (t.innerHTML = e));
                    t = 0;
                  } catch (e) {}
                }
          ...
          function (e, t) {
            ke.fn[e] = function (e) {
              for (var n, r = [], i = ke(e), o = i.length - 1, a = 0; a <= o; a++)
                (n = a === o ? this : this.clone(!0)), ke(i[a])[t](n), he.apply(r, n.get());
        ...
        style: function (e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var i,
              ...
              u = vt.test(t),
              l = e.style;
            if ((u || (t = F(s)), (a = ke.cssHooks[t] || ke.cssHooks[s]), void 0 === n))
              return a && 'get' in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
            (o = typeof n),
              'string' === o && (i = Ge.exec(n)) && i[1] && ((n = T(e, t, i)), (o = 'number')),
              null != n &&
                n === n &&
                ('number' === o && (n += (i && i[3]) || (ke.cssNumber[s] ? '' : 'px')),
                we.clearCloneStyle ||
                  '' !== n ||
        ...
        ke.each(['height', 'width'], function (e, t) {
          ke.cssHooks[t] = {
            ...
            set: function (e, n, r) {
              var i,
                o = dt(e),
                a = 'border-box' === ke.css(e, 'boxSizing', !1, o),
                s = r && z(e, t, r, a, o);
              return (
                a &&
                  we.scrollboxSize() === o.position &&
                  (s -= Math.ceil(
          ...
          attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
              return void 0 === e.getAttribute
                ...
                : ((1 === o && ke.isXMLDoc(e)) ||
                    (i =
                      ke.attrHooks[t.toLowerCase()] || (ke.expr.match.bool.test(t) ? kt : void 0)),
                  void 0 !== n
                    ? null === n
        ...
        ke.each(ke.expr.match.bool.source.match(/\w+/g), function (e, t) {
          ...
          St[t] = function (e, t, r) {
            var i,
              ...
              a = t.toLowerCase();
            return (
              r || ((o = St[a]), (St[a] = i), (i = null != n(e, t, r) ? a : null), (St[a] = o)), i
            );
          };
        });
      ...
      ke.fn.extend({
        ...
        ke.extend({
          prop: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
              return (
                (1 === o && ke.isXMLDoc(e)) || ((t = ke.propFix[t] || t), (i = ke.propHooks[t])),
                void 0 !== n
                  ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
                    ? r
                    : (e[t] = n)
          ...
          propHooks: {
            tabIndex: {
              get: function (e) {
                ...
                return t
                  ? parseInt(t, 10)
                  : Dt.test(e.nodeName) || (Nt.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
              },
            },
          ...
          toggleClass: function (e, t) {
            ...
            return 'boolean' == typeof t && r
              ...
              : this.each(function () {
                  var t, i, o, a;
                  if (r)
                    for (i = 0, o = ke(this), a = ne(e); (t = a[i++]); )
                    ...
                    (void 0 !== e && 'boolean' !== n) ||
                      ...
                      this.setAttribute &&
                        this.setAttribute(
                          'class',
                          t || !1 === e ? '' : _e.get(this, '__className__') || ''
                        ));
                });
          },
          hasClass: function (e) {
      ...
      ke.fn.extend({
        val: function (e) {
            ...
            i = this[0];
          {
            ...
            if (i)
              return (t = ke.valHooks[i.type] || ke.valHooks[i.nodeName.toLowerCase()]) &&
                'get' in t &&
                void 0 !== (n = t.get(i, 'value'))
                ? n
                : ((n = i.value), 'string' == typeof n ? n.replace(jt, '') : null == n ? '' : n);
          }
        },
      }),
        ke.extend({
          ...
          if (
            ...
            for (o = 0; (a = d[o++]) && !e.isPropagationStopped(); )
              (p = a),
                ...
                (c = (_e.get(a, 'events') || {})[e.type] && _e.get(a, 'handle')),
                c && c.apply(a, t),
                (c = l && a[l]) &&
                  c.apply &&
                  Fe(a) &&
            ...
            return (
              ...
              i ||
                ...
                (l &&
                  ...
                  e.isPropagationStopped() && p.addEventListener(h, qt),
                  r[h](),
                  e.isPropagationStopped() && p.removeEventListener(h, qt),
      ...
      ke.parseXML = function (e) {
        ...
        return (
          (t && !t.getElementsByTagName('parsererror').length) || ke.error('Invalid XML: ' + e), t
        );
      };
      var Pt = /\[\]$/,
        Mt = /\r?\n/g,
          ...
          ajax: function (e, t) {
            function r(e, t, r, s) {
              ...
              c ||
                ...
                y.fireWith(g, [C, T]),
                f &&
                  (v.trigger('ajaxComplete', [C, h]), --ke.active || ke.event.trigger('ajaxStop')));
            }
            ...
            var i,
              ...
              C = {
                ...
                setRequestHeader: function (e, t) {
                  return (
                    null == c && ((e = w[e.toLowerCase()] = w[e.toLowerCase()] || e), (b[e] = t)),
                    this
                  );
                },
            ...
            if (
              (m.promise(C),
              (h.url = ((e || h.url || Lt.href) + '').replace(Xt, Lt.protocol + '//')),
              ...
              h.hasContent
                ...
                : ((d = h.url.slice(o.length)),
                  h.data &&
                    ...
                    ((o += (Ot.test(o) ? '&' : '?') + h.data), delete h.data),
                  !1 === h.cache &&
                    ((o = o.replace(Bt, '$1')), (d = (Ot.test(o) ? '&' : '?') + '_=' + Ht++ + d)),
                  (h.url = o + d)),
              h.ifModified &&
                (ke.lastModified[o] && C.setRequestHeader('If-Modified-Since', ke.lastModified[o]),
      ...
      (we.cors = !!Jt && 'withCredentials' in Jt),
        (we.ajax = Jt = !!Jt),
        ke.ajaxTransport(function (e) {
          var t, r;
          if (we.cors || (Jt && !e.crossDomain))
            return {
              send: function (i, o) {
                var a,
                  s = e.xhr();
      ...
      ke.ajaxSetup({
          ...
          if (s || 'jsonp' === e.dataTypes[0])
            return (
              ...
              s
                ...
                : !1 !== e.jsonp && (e.url += (Ot.test(e.url) ? '&' : '?') + e.jsonp + '=' + i),
        ...
        (ke.parseHTML = function (e, t, n) {
          ...
          return (
            ...
            i
              ? [t.createElement(i[1])]
              : ((i = D([e], t, o)), o && o.length && ke(o).remove(), ke.merge([], i.childNodes))
          );
        }),
        (ke.fn.load = function (e, t, n) {
          var r,
            ...
            s = e.indexOf(' ');
          return (
            s > -1 && ((r = ee(e.slice(s))), (e = e.slice(0, s))),
        ...
        ke.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (e, t) {
          ...
          ke.fn[e] = function (r) {
            return We(
              ...
              function (e, r, i) {
                var o;
                if ((Ce(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView), void 0 === i))
                  return o ? o[t] : e[r];
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      e(function () {
        var t = (e(window).width(), e('#back-top'));
        if (
          (e(window).scroll(function () {
            e(window).scrollTop() > 300 ? t.addClass('show') : t.removeClass('show');
          }),
          t.on('click', function (t) {
            t.preventDefault(), (e.easing.def = 'ease'), e('html, body').animate({ scrollTop: 0 });
          }),
          e('.single-question').click(function () {
            e(this).toggleClass('open'), e(this).find('.expandable').toggle(200);
          }),
          e('.navbar a, .email-link, .footer-section a').click(function (t) {
            if (
              this.hash &&
              this.hash.length > 1 &&
              ...
              var n = e(this.hash);
              if (((n = n.length ? n : e('[id=' + this.hash.slice(1) + ']')), n.length))
                return (
                  e('html,body').stop().animate({ scrollTop: n.offset().top }, 100, 'linear'), !1
                );
            }
          }),
          ...
          if (
            ...
            var r = e(n);
            if (((r = r.length ? r : e('[id=' + n.slice(1) + ']')), r.length))
              return e('html,body').animate({ scrollTop: r.offset().top }, 100, 'linear'), !1;
          }
        }
        e(window).on('load resize', function () {
          e('.slider__contents').width(e('.slider').width() - 60);
        });
      });
    }.call(t, n(1)));
  },
